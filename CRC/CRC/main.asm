...
main:
;------------------- сообщение
	ldi		Msg_frstBit, 0x10						
	ldi		Msg_scndBit, 0x10						
;------------------- заполнение crc единицами
	ldi		crc_frst, 0xFF							
	ldi		crc_scnd, 0xFF							
;------------------- полином модбаса
	ldi		pol_frst, 0xA0
	...
	eor		crc_frst, Msg_frstBit					; исключающее или с первыми 8 битами сообщения
